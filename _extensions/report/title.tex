...
% Quarto extension after it's installed
\def\logopathA{_extensions/fuhrmanator/report/Logo_ETS_TypoGrise_D_FR_1}
% Quarto extension before it's installed (there's no github username)
\def\logopathB{_extensions/report/Logo_ETS_TypoGrise_D_FR_1}

% Macro to check file existence and include graphic
...
\hbox to 16cm{
  \hbox to 6.5cm{\vbox to 14cm{\vbox to 22cm{
    % display one or the other logo
    \includegraphicspath[width=6cm]{\logopathA}
    \includegraphicspath[width=6cm]{\logopathB}
    % \includegraphics[width=6cm]{_extensions/fuhrmanator/report/Logo_ETS_TypoGrise_D_FR_1}
    \vfill
